...
export default function TypingIndicator() {
  return (
    <div className="inline-flex items-center bg-amber-50 border-l-4 border-amber-600 rounded-lg p-2 sm:p-3 max-w-[70%] sm:max-w-[60%] animate-fadeIn border-t border-r border-b border-amber-200">
      <p className="text-amber-800 mr-2 font-serif text-sm sm:text-base">Divine wisdom flowing</p>
